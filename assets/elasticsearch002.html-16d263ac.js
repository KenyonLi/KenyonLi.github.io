import{_ as s,r as l,o as d,c as r,a as e,b as n,w as t,d as a,e as c}from"./app-1642d2c6.js";const u={},v=e("h2",{id:"目录",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#目录","aria-hidden":"true"},"#"),a(" 目录")],-1),o={class:"table-of-contents"},p=c(`<h1 id="elasticsearch-分词器" tabindex="-1"><a class="header-anchor" href="#elasticsearch-分词器" aria-hidden="true">#</a> ElasticSearch-分词器</h1><h2 id="什么是分词器" tabindex="-1"><a class="header-anchor" href="#什么是分词器" aria-hidden="true">#</a> 什么是分词器</h2><p>将：一段文字拆分成为独立的词。</p><h2 id="elasticsearch为什么要使用分词" tabindex="-1"><a class="header-anchor" href="#elasticsearch为什么要使用分词" aria-hidden="true">#</a> ElasticSearch为什么要使用分词</h2><h3 id="直接全文本查询" tabindex="-1"><a class="header-anchor" href="#直接全文本查询" aria-hidden="true">#</a> 直接全文本查询</h3><h3 id="模糊查询" tabindex="-1"><a class="header-anchor" href="#模糊查询" aria-hidden="true">#</a> 模糊查询</h3><h3 id="分词器查询" tabindex="-1"><a class="header-anchor" href="#分词器查询" aria-hidden="true">#</a> 分词器查询</h3><h2 id="elasticsearch分词器如何落地" tabindex="-1"><a class="header-anchor" href="#elasticsearch分词器如何落地" aria-hidden="true">#</a> ElasticSearch分词器如何落地</h2><p>条件</p><p>1、电商项目</p><p>2、Elasticsearch</p><p>3、NEST</p><p>步骤</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1、然后创建电商项目
  vs2019创建项目
