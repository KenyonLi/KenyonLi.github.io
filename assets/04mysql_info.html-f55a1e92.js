import{_ as t,r as l,o as s,c as r,a as e,b as a,w as d,d as i,e as c}from"./app-1642d2c6.js";const u={},v=e("h2",{id:"目录",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#目录","aria-hidden":"true"},"#"),i(" 目录")],-1),m={class:"table-of-contents"},o=c(`<h2 id="一、索引分类" tabindex="-1"><a class="header-anchor" href="#一、索引分类" aria-hidden="true">#</a> 一、索引分类</h2><div class="custom-container tip"><p class="custom-container-title">参考</p><blockquote><p><a href="/file/mysql/04.MySQL%E7%B4%A2%E5%BC%95%E7%AF%87.pdf">04.MySQL索引篇</a></p></blockquote></div><h3 id="_1-根据主次来分" tabindex="-1"><a class="header-anchor" href="#_1-根据主次来分" aria-hidden="true">#</a> 1）根据主次来分</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>	主索引：主键创建的索引，只要是主键会自动创建索引。
	辅助索引：非主键字段上创建的索引
		唯一索引
		组合索引
		普通索引
