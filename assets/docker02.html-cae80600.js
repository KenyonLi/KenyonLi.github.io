import{_ as c,r as l,o,c as r,a as n,b as a,w as i,d as s,e as d}from"./app-1642d2c6.js";const p="/images/docker/02/docker02_0001.png",t="/images/docker/02/docker02_0002.png",u={},v=n("h2",{id:"目录",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#目录","aria-hidden":"true"},"#"),s(" 目录")],-1),m={class:"table-of-contents"},k=d('<h2 id="docker-集群" tabindex="-1"><a class="header-anchor" href="#docker-集群" aria-hidden="true">#</a> Docker-集群</h2><h2 id="什么是docker集群" tabindex="-1"><a class="header-anchor" href="#什么是docker集群" aria-hidden="true">#</a> 什么是docker集群</h2><h3 id="什么是集群" tabindex="-1"><a class="header-anchor" href="#什么是集群" aria-hidden="true">#</a> 什么是集群</h3><p>1、先生活中集群</p><p>2、再软件中集群</p><p>3、最后总结</p><p>总结：不同服务实例，来共同提供服务的一组集合就是集群</p><h3 id="集群类型" tabindex="-1"><a class="header-anchor" href="#集群类型" aria-hidden="true">#</a> 集群类型</h3><p>1、先看两个集群例子：nginx集群，redis集群</p><p>2、然后总结</p><p>1、对称集群</p><p>​ 不同服务实例，功能地位相等(每一个实例提供的功能机会相同)</p><p>​ 定位：数据计算</p><p>2、非对称集群</p><p>​ 不同服务实例，功能地位不相等(每一个实例提供功能的机会不相同)</p><p>​ 定位：数据存储</p><h3 id="什么是docker集群-1" tabindex="-1"><a class="header-anchor" href="#什么是docker集群-1" aria-hidden="true">#</a> 什么是docker集群</h3><p>总结</p><p>1、docker集群是非对称集群 <img src="'+p+`" alt="Alt text"> ​ 见图进行解析</p><p>为什么要使用docker集群 ​ 从<code>docker</code>集群图来进行分析，<code>docker</code>里面运行着容器，如果<code>docker</code>宕机？</p><p><code>docker</code>容器对外提供 访问，如果访问量越大，一台<code>docker</code>的并发量毕竟有限</p><p>总结：</p><p>​ 1、单点故障问题</p><p>​ 2、性能问题</p><p>所以为了解决这两个问题，就出现了<code>docker</code>集群</p><h2 id="实现docker集群方式" tabindex="-1"><a class="header-anchor" href="#实现docker集群方式" aria-hidden="true">#</a> 实现docker集群方式</h2><p>​ 1、<code>swarm</code></p><p>​ 2、<code>k8s</code></p><p>​ 但是我们今天只会讲解<code>swarm</code>,今天我们选择<code>swarm</code></p><p>选择原因</p><p>1、<code>swarm</code>是<code>docker</code>官方提供的集群工具</p><p>2、<code>k8s</code>是谷歌开发的</p><p>3、<code>k8s</code>理解使用起来比较难</p><h2 id="swarm如何管理docker集群" tabindex="-1"><a class="header-anchor" href="#swarm如何管理docker集群" aria-hidden="true">#</a> swarm如何管理docker集群</h2><h3 id="swarm是什么-怎么理解" tabindex="-1"><a class="header-anchor" href="#swarm是什么-怎么理解" aria-hidden="true">#</a> swarm是什么，怎么理解？</h3><p><code>swarm</code> 就好比是地铁购票机安装员。同理<code>swarm</code>就是地铁购票机安装员</p><p><code>Docker Swarm </code>是 <code>Docker</code> 的集群管理工具。它将 <code>Docker</code> 主机池转变为单个虚拟 <code>Docker</code> 主机。 <code>Docker Swarm</code> 提供了标准的 <code>Docker API</code>，所有任何已经与 <code>Docker</code> 守护程序通信的工具都可以使用 <code>Swarm</code> 轻松地扩展到多个主机。</p><h3 id="swarm内部概念" tabindex="-1"><a class="header-anchor" href="#swarm内部概念" aria-hidden="true">#</a> swarm内部概念</h3><p>1、<code>node</code>节点概念</p><p>2、<code>task</code>概念 — 运行的容器</p><p>3、<code>service</code>概念 — 服务</p><p>4、<code>stack</code>概念 批量运行 服务</p><p>就是将集群的<code>docker</code>通过<code>node</code>分配角色的方式进行维护</p><p><code>node</code> 就是<code>docker</code>的别名，就好比，我们去公司上班，每一个人都有一个工号，工号就是我们的别名，那么<code>node</code>就是<code>docker</code>的别名，但是<code>node</code>有两个类型，<code>manager</code> 和<code>work</code>，就是讲<code>docker</code>分成了两类，就好比，公司里面有老板和员工，<code>manager</code>就是老板，<code>work</code>就是员工，老板是管理的，员工是干事的。有时候人工不够的时候，老板也过来干事。</p><p>1、<code>node</code> ：<code>docker</code>主机</p><p>2、管理节点（<code>manager</code>）</p><p>​ 管理<code>docker</code>集群</p><p>​ 1、集群配置</p><p>​ 2、容器服务管理。</p><p>​ 3、负载均衡</p><p>​ 4、集群管理？</p><p>3、工作节点 (<code>worker</code>)</p><p>​ 1、提供容器服务</p><h3 id="swarm是如何操作集群节点容器的" tabindex="-1"><a class="header-anchor" href="#swarm是如何操作集群节点容器的" aria-hidden="true">#</a> swarm是如何操作集群节点容器的？</h3><p>在使用之前我们必须要准备一些概念，这些概念是<code>swarm</code>的核心，掌握了这些概念，就已经理解了<code>swarm</code> 50%</p><p>后面都是基于这些概念的操作</p><p><code>service</code>是什么？</p><p>​ 是指不同节点容器集合，用来维护容器</p><p><code>task</code>是什么？</p><p>​ 在集群环境中，用来运行容器</p><p><code>stack</code>是什么？</p><p>​ 是指<code>stack</code>的集合，用来维护<code>service</code></p><h3 id="swarm如何创建docker集群" tabindex="-1"><a class="header-anchor" href="#swarm如何创建docker集群" aria-hidden="true">#</a> swarm如何创建docker集群</h3><p>条件</p><p>1、两台以上<code>docker</code>主机</p><p>2、<code>docker swarm</code></p><p>步骤</p><p>1、安装两台<code>docker</code>主机，使用<code>linux</code>或者<code>centos9.0</code>以上</p><p>​ 安装 24.0.7 版本以上的<code>docker</code>，会在主机上默认提供支持</p><p>2、如何使用<code>docker swarm</code>？</p><p>​ 1、输出<code>docker</code>命令，会看到有一个<code>swarm</code>管理命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>​ <span class="token function">docker</span> swarm
