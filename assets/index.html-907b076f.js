import{_ as r,r as d,o,c,a as e,b as l,w as t,d as s,e as a}from"./app-1642d2c6.js";const u="/images/mysql/ae0d4f5761a76527da2438c614e91f17.png",m="/images/mysql/image00.png",v={},b=e("h2",{id:"目录",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#目录","aria-hidden":"true"},"#"),s(" 目录")],-1),h={class:"table-of-contents"},p=a(`<div class="custom-container tip"><p class="custom-container-title">环境安装</p><blockquote><ul><li>mysql: ubunto 20. 安装 mysql 8.0</li><li>安装：</li></ul></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>sudo apt install mysql-server
