import{_ as l,r as d,o as t,c as r,a as e,b as s,w as a,d as i,e as u}from"./app-d2abbc6e.js";const c="/images/abp/abp013/image-20220210164251590.png",v="/images/abp/abp013/image-20220210165233318.png",o="/images/abp/abp013/image-20220210165324965.png",p={},b=e("h2",{id:"目录",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#目录","aria-hidden":"true"},"#"),i(" 目录")],-1),m={class:"table-of-contents"},g=u(`<h1 id="核心组件-用户组件-设置模块" tabindex="-1"><a class="header-anchor" href="#核心组件-用户组件-设置模块" aria-hidden="true">#</a> 核心组件-用户组件-设置模块</h1><h2 id="什么是设置" tabindex="-1"><a class="header-anchor" href="#什么是设置" aria-hidden="true">#</a> 什么是设置</h2><p>多个客户租用系统，例如：多个公司租用阿里云服务器</p><h2 id="什么是设置模块" tabindex="-1"><a class="header-anchor" href="#什么是设置模块" aria-hidden="true">#</a> 什么是设置模块</h2><p>对租户实现增删改查。就是设置管理模块</p><h2 id="为什么使用设置" tabindex="-1"><a class="header-anchor" href="#为什么使用设置" aria-hidden="true">#</a> 为什么使用设置</h2><p>目的：为了将系统设计为Saas系统</p><h2 id="电商项目中如何集成设置模块" tabindex="-1"><a class="header-anchor" href="#电商项目中如何集成设置模块" aria-hidden="true">#</a> 电商项目中如何集成设置模块</h2><h3 id="设置模块源码" tabindex="-1"><a class="header-anchor" href="#设置模块源码" aria-hidden="true">#</a> 设置模块源码</h3><p>下载地址：</p><p>https://github.com/abpframework/abp/tree/dev/modules/SettingManagement</p><p>源码介绍：</p><h3 id="lkn-ebusiness-domain-shared如何集成设置模块" tabindex="-1"><a class="header-anchor" href="#lkn-ebusiness-domain-shared如何集成设置模块" aria-hidden="true">#</a> LKN.EBusiness.Domain.Shared如何集成设置模块</h3><p>条件</p><p>1、Volo.Abp.SettingManagement.Domain.Shared</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>步骤
