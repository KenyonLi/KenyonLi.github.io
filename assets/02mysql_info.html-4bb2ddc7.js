import{_ as a,r as t,o as s,c as r,a as e,b as d,w as l,d as n,e as c}from"./app-1642d2c6.js";const o={},v=e("h2",{id:"目录",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#目录","aria-hidden":"true"},"#"),n(" 目录")],-1),u={class:"table-of-contents"},b=c(`<h2 id="一、innodb的磁盘结构" tabindex="-1"><a class="header-anchor" href="#一、innodb的磁盘结构" aria-hidden="true">#</a> 一、InnoDB的磁盘结构</h2><h3 id="_1、redolog文件" tabindex="-1"><a class="header-anchor" href="#_1、redolog文件" aria-hidden="true">#</a> 1、redolog文件</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>	由一组文件组成
	循环写
	默认是两个文件：
		ib_logfile0
		ib_logfile1
