import{_ as l,r as s,o as t,c,a as e,b as d,w as a,d as i,e as r}from"./app-1642d2c6.js";const v={},u=e("h2",{id:"目录",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#目录","aria-hidden":"true"},"#"),i(" 目录")],-1),o={class:"table-of-contents"},m=r(`<h2 id="一、innodb锁篇" tabindex="-1"><a class="header-anchor" href="#一、innodb锁篇" aria-hidden="true">#</a> 一、InnoDB锁篇</h2><h3 id="_1、什么是lbcc" tabindex="-1"><a class="header-anchor" href="#_1、什么是lbcc" aria-hidden="true">#</a> 1、什么是lbcc</h3><div class="custom-container tip"><p class="custom-container-title">参考配置</p><blockquote><p><a href="/file/mysql/03.MySQL%E4%BA%8B%E5%8A%A1%E7%AF%87.pdf">0.3 MySQL事务篇</a></p></blockquote></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>基于锁的并发控制
