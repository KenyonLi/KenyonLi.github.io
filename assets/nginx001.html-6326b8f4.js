...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><blockquote><p>1.3、然后启动电商系统实例一</p></blockquote></blockquote><blockquote><blockquote><p>​ 1.4、然后再启动电商系统实例二</p></blockquote></blockquote><blockquote><p>2、Nginx准备</p></blockquote><blockquote><blockquote><p>​ 2.1 先进入到Nginx中</p></blockquote></blockquote><p><img src="`+v+`" alt="Alt text"></p><blockquote><blockquote><p>2.2 然后打开nginx.conf配置，在里面添加</p></blockquote></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#user  nobody;</span>
...
stream <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查询商品web应用场景" tabindex="-1"><a class="header-anchor" href="#查询商品web应用场景" aria-hidden="true">#</a> 查询商品Web应用场景</h3><blockquote><p>如果商品是在电商Web网站中，这个时候从电商网站当中查询商品的时候，会同时加载两类数据，静态 数据和动态数据，静态数据：js css 图片，视频，音频等等，动态资源：商品数据。如果访问js css 并发量比较大，会出现cpu，内存等资源全部被耗尽，导致动态数据加载没有资源可用，所以，导致动态资源请求导致性能下降问题？如何提升性能？</p></blockquote><blockquote><p>方案：动静分离</p></blockquote><blockquote><p>前提</p></blockquote><blockquote><p>1、电商web系统</p></blockquote><blockquote><p>步骤</p></blockquote><blockquote><p>1、使用vs2022创建电商web系统</p></blockquote><p><img src="`+_+'" alt="Alt text"> ​</p><p>如何落地动静分离 条件</p><p>1、LKN.EBusiness.Web</p><p>2、Nginx</p><p>步骤</p><p>1、先进入到LKN.EBusiness.Web中</p><p>​ 将wwwroot文件拆分到放到LKN.EBusiness.StaticResource目录中</p><p><img src="'+h+`" alt="Alt text"></p><p>1、然后进入Nginx中，在nginx.conf文件中添加</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#user  nobody;</span>
worker_processes  <span class="token number">1</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>4 切换到/nginx/nginx-1.17.1</p><blockquote><p>执行./configure make make install 进行安装 5 切换到/usr/local/nginx/sbin 执行 ./nginx 启动nginx</p></blockquote></blockquote><blockquote><p>yum方式</p></blockquote><blockquote><p>192.168.44.4：</p></blockquote><h3 id="_1-安装-nginx需要工具" tabindex="-1"><a class="header-anchor" href="#_1-安装-nginx需要工具" aria-hidden="true">#</a> 1 安装 nginx需要工具</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>	 yum <span class="token parameter variable">-y</span> <span class="token function">install</span> gcc <span class="token function">make</span> pcre-devel zlib-devel <span class="token function">tar</span> zlib
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-切换到-nginx-nginx-1-17-1" tabindex="-1"><a class="header-anchor" href="#_4-切换到-nginx-nginx-1-17-1" aria-hidden="true">#</a> 4 切换到/nginx/nginx-1.17.1</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>	执行./configure
		make
		make install 进行安装
